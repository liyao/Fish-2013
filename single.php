			...
			<?php if ( have_posts() ) while ( have_posts() ) : the_post(); ?>
				<article id="post-<?php the_ID(); ?>" <?php post_class(); ?> role="article">
					...
					<div class="entry-content">
						<?php the_content(); ?>
						<p>
							如果您觉得本文的内容对您的学习有所帮助，可以选择对小肥鱼进行捐助：<a href='http://me.alipay.com/leeyao' target="_blank"> <img src='https://img.alipay.com/sys/personalprod/style/mc/btn-index.png' /> </a>
						</p>
